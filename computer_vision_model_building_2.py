...
class computer_vision_building_2(object):
    ...
    def __init__(self, model_type, image_type):
        ...
        if self.image_type == "normal":
            self.true_path = self.true_path + "Train/"
        ...
        self.category_names_2 = ["Bumpy road", 
            			"Slippery road", 
            			"Road narrows on the right", 
            			"Road work", 
            			"Traffic signals", 
        ...
        self.check_valid(self.advanced_categories_2[14])
        self.check_valid(self.advanced_categories_2[15])
        self.check_valid(self.advanced_categories_2[16])
        self.check_valid(self.advanced_categories_2[17])
        self.check_valid(self.advanced_categories_2[18])
        self.check_valid(self.advanced_categories_2[19])
        self.check_valid(self.advanced_categories_2[20])
        ...
        self.resize_image_and_label_image(self.advanced_categories_2[14])
        self.resize_image_and_label_image(self.advanced_categories_2[15])
        self.resize_image_and_label_image(self.advanced_categories_2[16])
        self.resize_image_and_label_image(self.advanced_categories_2[17])
        self.resize_image_and_label_image(self.advanced_categories_2[18])
        self.resize_image_and_label_image(self.advanced_categories_2[19])
        self.resize_image_and_label_image(self.advanced_categories_2[20])
